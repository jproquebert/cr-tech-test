  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 gap-2">
        <h3 className="text-xl sm:text-2xl font-extrabold tracking-tight text-white">{task.Title}</h3>
        <span
        ...
        <button
          className="ml-2 p-2 rounded-full bg-gray-800 hover:bg-blue-600 text-blue-300 hover:text-white transition"
          title="Edit Task"
      ...
      <p className="text-gray-200 mb-4 italic">{task.Description || "No description"}</p>
