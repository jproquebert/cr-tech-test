...
export function Sidebar({ email, onAddTask }: SidebarProps) {
  return (
    <aside className="w-64 h-screen bg-gray-900 border-r border-blue-700 shadow-2xl flex flex-col items-center py-8 px-4 sticky top-0 left-0 rounded-r-2xl">
      ...
      {email && (
        <button
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-green-600 hover:bg-green-700 text-white font-bold shadow transition mb-8 w-full justify-center"
          onClick={onAddTask}
        >
